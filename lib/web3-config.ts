...
export const BASE_SEPOLIA_CONFIG = {
  ...
  rpcUrl:
    ...
    "https://base-sepolia.g.alchemy.com/v2/Nlqb7FgqigV25XoAODWhD",
...
// Also keep USDC_ABI for backward compatibility
export const USDC_ABI = ERC20_ABI;

// Deployed Remittance contract address
export const REMITTANCE_CONTRACT_ADDRESS =
  (typeof process !== "undefined" &&
    process.env?.NEXT_PUBLIC_REMITTANCE_CONTRACT) ||
...
export const REMITTANCE_ABI = [
  ...
  {
    inputs: [],
    name: "getAllSupportedStablecoins",
    outputs: [
      {
        internalType: "address[]",
        name: "",
  ...
  },
  {
    ...
    name: "getReferralRewardsBalance",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  },
  {
    ...
    name: "getReferralRewardsHistory",
    outputs: [
      {
        components: [
          {
        ...
        internalType: "struct Remittance.ReferralReward[]",
        name: "",
        type: "tuple[]",
      },
    ],
...
// Default export for REMITTANCE_ABI
export default REMITTANCE_ABI;
